...
## 1. 更新整理: Minecrafts Tiny Takeover

Twitch Blog の更新を短く整理しました。要点だけ先に確認したい人向けです。 https://blog.twitch.tv/en/2026/04/06/minecrafts-tiny-takeover/

- ALT: Twitch Blog の更新要点を整理したカード画像。タイトルは Minecrafts Tiny Takeover。
- 画像: assets/cards/first-3-minutes-hook.png

## 2. 更新整理: OBS Studio 32.1.1
